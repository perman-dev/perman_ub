...
if Config.ENABLE_ASSISTANTBOT == "ENABLE":
    ...
    sed.info("PermanUserbot And Assistant Bot Have Been Installed Successfully !")
else:
    sed.info("PermanUserbot Has Been Installed Sucessfully !")
    sed.info("You Can contact @ElricX For Any Support Or Doubts")
